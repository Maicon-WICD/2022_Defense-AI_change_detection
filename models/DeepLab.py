...
def xception_65(num_classes=None,
                ...
                scope='xception_65',
                pretrained=True,
                checkpoint_path='./models/pretrained/xception_65.pth'):
    """Xception-65 model."""
    xception = Xception65(num_classes=num_classes, global_pool=global_pool, 
                          keep_prob=keep_prob, output_stride=output_stride,
                          scope=scope)
    if pretrained:
        _load_state_dict(xception, num_classes, checkpoint_path='./models/pretrained/xception_65.pth')
    return xception
...
if __name__ == '__main__':
    ...
    model = DeepLab(num_classes=4).to(device)
    summary(model,(16,3, 256, 480))
